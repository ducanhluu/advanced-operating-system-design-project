/* Copyright 2003   R. Civalero   L.G.P.L.
   ...
   Inspiré du fichier list.h de Linux 
	...
	Pour créer une file :
	 ...
	 3) APRES les avoir crées, ajouter des éléments dans la file 
	...
	Pour utiliser la file :
	 ...
	 - R�cuperer et enlever de la file l'élément prioritaire avec 
	   la macro queue_out,
 ...
 * sont initialis�es à 0 (respectivement par l'allocateur et par le crt0).
 */
